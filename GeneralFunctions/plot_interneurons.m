function plot_interneurons(data,cellno,varargin)
...
args=struct('category',1,'modality','dFoY','NovFam',0);
% modality: dFoY, dFoDY, stimuli
% NovFam: plot novel and familiar portion of the runs separately
